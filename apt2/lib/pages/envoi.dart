...
class EnvoiPage extends StatefulWidget {
  const EnvoiPage({super.key});

  @override
  _EnvoiPageState createState() => _EnvoiPageState();
}
...
class _EnvoiPageState extends State<EnvoiPage> {
  ...
  final TextEditingController recipientController =
      TextEditingController(); // TextField fonctionne
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        //Permet de scroller pour éviter le débordement
        child: Padding(
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10),
                    _buildCardButton("Eblbvgfhftrbffgtg"),
                  ],
                ),
              ),
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        isAgreed
                            ? Colors.blue
                            : Colors.grey, // ✅ Désactivé si case non cochée
